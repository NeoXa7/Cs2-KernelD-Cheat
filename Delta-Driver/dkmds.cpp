...
NTSTATUS DriverMain(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path)
{
	...
	RtlInitUnicodeString(&device_name, L"\\Device\\Delta"); // the device name should be same as the driver name
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\Delta"); // DosDevices
...
NTSTATUS DriverEntry()
{
	...
	RtlInitUnicodeString(&driver_name, L"\\Driver\\Delta"); // Driver
