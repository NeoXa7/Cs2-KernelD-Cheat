...
VOID Mouse::Move::OnAxisY(int dx, int dy)
{
	INPUT input = { 0 };
...
VOID Mouse::Move::OnAxisX(int dx, int dy)
{
	INPUT input = { 0 };
...
VOID Mouse::Move::ToClosest2DVector(Vector2 position)
{
