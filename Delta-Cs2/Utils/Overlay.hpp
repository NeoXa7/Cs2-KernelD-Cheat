...
inline VOID ShowErrorBox(const std::wstring& errorMessage, const std::wstring& errorTitle)
{
...
inline VOID ShowWarningBox(const std::wstring& warningMessage, const std::wstring& warningTitle)
{
