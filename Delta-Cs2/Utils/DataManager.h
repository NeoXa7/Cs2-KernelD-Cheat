...
inline VOID SaveCheatData()
{
    ...
    // Save Aimbot Data
    {
        ...
        jsonConfig["Aimbot"]["HotkeyIndex"] = Data::Aimbot::m_iCurrentHotkeyIndex;
...
inline VOID LoadCheatData()
{
    ...
    if (Data.contains("Aimbot"))
    {
        ...
        Data::Aimbot::m_iCurrentHotkeyIndex = aimbot["HotkeyIndex"];
...
inline VOID SaveOtherData()
{
    ...
    jsonConfig["Flags"]["g_MovementCheats"] = Flags::MovementCheats;
